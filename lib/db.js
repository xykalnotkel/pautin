...
const DEMO = [
  {
    ...
    bio: "Developer dan kreator konten. Tips coding, teknologi, dan produktivitas.",
    theme: "galaxy", radius: "soft", views: 4128,
    links: [
      { title: "YouTube — channel coding-ku", url: "https://youtube.com/@rizkypratama", icon: "play", clicks: 812 },
      { title: "Tulisan di blog", url: "https://medium.com/@rizkypratama", icon: "article", clicks: 543 },
      { title: "Gabung komunitas Discord", url: "https://discord.gg", icon: "chat", clicks: 391 },
      { title: "Dukung karyaku", url: "https://saweria.co/rizky", icon: "heart", clicks: 77 },
  ...
  },
  {
    ...
    bio: "Foodie dan traveller. Resep rumahan, itinerary seru, dan cerita perjalanan.",
    theme: "mawar", radius: "full", views: 2856,
    links: [
      { title: "Resep harian — blog", url: "https://medium.com/@nadia.ayu", icon: "article", clicks: 402 },
      { title: "Itinerary liburan gratis", url: "https://drive.google.com", icon: "folder", clicks: 311 },
      { title: "Koleksi resep di YouTube", url: "https://youtube.com/@nadiaayu", icon: "play", clicks: 287 },
      { title: "Dukung perjalananku", url: "https://saweria.co/nadia", icon: "heart", clicks: 45 },
  ...
  },
  {
    ...
    bio: "Kedai kopi kecil di sudut kota. Buka setiap hari pukul 08.00-22.00.",
    theme: "kopi", radius: "sharp", views: 1630,
    links: [
      { title: "Order dan reservasi via WhatsApp", url: "https://wa.me/6281234567890", icon: "chat", clicks: 245 },
      { title: "Lihat lokasi di Google Maps", url: "https://maps.google.com/?q=kopi+kita", icon: "pin", clicks: 167 },
      { title: "Playlist teman ngopi", url: "https://open.spotify.com", icon: "music", clicks: 98 },
    ...
    for (const u of DEMO) {
      ...
      for (let i = 0; i < u.links.length; i++) {
        ...
        await db.execute({
          ...
          args: [uid, l.title, l.url, l.icon || "", kindOf(l.url), i, l.clicks || 0, now()],
        });
      }
    }
  } catch (e) {
