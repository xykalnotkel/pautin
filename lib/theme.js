...
h1.name{font-size:25px;font-weight:800;letter-spacing:-.4px;font-family:var(--font-sora),sans-serif}
...
.si{width:44px;height:44px;border-radius:50%;display:flex;align-items:center;justify-content:center;background:var(--btn);border:1px solid var(--line);color:var(--fg);transition:.18s;backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px)}
...
.lnk{display:flex;align-items:center;gap:14px;background:var(--btn);border:1px solid var(--line);border-radius:var(--rad);padding:12px 17px;color:var(--fg);text-decoration:none;backdrop-filter:blur(10px);-webkit-backdrop-filter:blur(10px);transition:transform .16s,box-shadow .16s,border-color .16s;text-align:left}
...
.lnk .ch{flex:0 0 42px;width:42px;height:42px;border-radius:50%;background:var(--chip);display:flex;align-items:center;justify-content:center;color:var(--fg)}
